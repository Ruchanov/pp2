...
road = pg.image.load('./images/animatedstreet.jpg')
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r'./images/enemy1.png')
        self.surf = pg.Surface((40, 60))
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("./images/coin1.png")
        self.mega_coin()
    ...
    def mega_coin(self):
        if self.random_number in [0, 1, 2]:
            self.image = pg.image.load("./images/supercoin.jpg")
            self.speed = 15
        else:
            self.image = pg.image.load("./images/coin1.png")
